        ...
        <div className='space-y-4 sm:space-y-6'>
          ...
          <nav aria-label='Breadcrumb'>
            <ol className='flex items-center gap-1 text-base'>
              ...
              <li>
                <div className='text-muted-foreground transition hover:text-primary'>
                  {post.title}
                </div>
              </li>
            </ol>
          ...
          {/* Post title */}
          <h1 className='text-3xl/snug font-semibold lg:text-5xl/tight'>
            {post.title}
          </h1>
          {/* Post keywords */}
          ...
          <BylineMetadata date={format(parseISO(post.date), 'LLLL d, yyyy')} />
        </div>
        <hr className='my-4' />
        {/* Post cover image */}
