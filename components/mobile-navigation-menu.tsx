      ...
      <Sheet>
        <SheetTrigger asChild>
          ...
          >
            ...
            <span className='sr-only'>Mobile navigation toggle Menu</span>
          </Button>
        </SheetTrigger>
        <SheetContent className='w-4/5 bg-card p-0'>
          <SheetHeader className='p-6 pb-4'>
            ...
            <SheetDescription className='mt-5'>
              ...
              praesentium corrupti fuga autem natus, earum nisi veniam minus
              vero blanditiis ex ut laborum fugit cumque rem? Amet, quae?
          ...
          <div className='grid gap-4 px-2 py-4'>
            {navItems.map((navItem) => (
              <Link
                key={navItem.label}
                href={navItem.href}
                className='rounded-full px-4 py-1.5 font-medium tracking-wide hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground'
              >
